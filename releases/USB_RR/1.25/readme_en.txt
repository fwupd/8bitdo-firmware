...
Date: 2018/5/29 V1.16
---------------------
1. Fixed the auto button issue for connection with Xbox one S/X Bluetooth controller.


Date: 2018/4/28 V1.15
---------------------
1. Added multiple connection on DINPUT、XINPUT、MAC and SWITCH for 8Bitdo Bluetooth controllers.
...
Date: 2018/3/24 V1.14
---------------------
1. Fixed the bug that the Receiver can't connect to Switch Pro and Switch Joy-Con controllers.
2. Enhanced the Vibration, and adjust to three levels – strong/weak/no vibration.
...
2. Vibration on PS4 controller can be modified to two levels – strong/weak.
